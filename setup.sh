...
Password=JebonRX
# Execute
read -p "Please Insert The License Key : " Password1
if [ $Password = $Password1 ]; then
clear
echo -e ""
echo -e "${green}Permission Accepted...${NC}"
echo ""
echo "Thanks For Using This Autoscript-Lite V2Remake"
echo ""
sleep 3
else
clear
...
# install cf
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
clear
echo -e "========================="
echo -e "Ready to install script"
echo -e "========================="
sleep 2
# install ssh & ovpn
echo -e "========================="
...
echo -e "========================="
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
#echo -e "\e[0;32mDONE INSTALLING SSH & OVPN\e[0m"
clear
# install ssr
#echo -e "\e[0;32mINSTALLING SS & SSR...\e[0m"
#sleep 1
#wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
#wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
...
echo -e "========================="
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
clear
#install Xray
echo -e "========================="
...
echo -e "========================="
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
clear
#install Trojan GO
#echo -e "\e[0;32mINSTALLING TROJAN GO...\e[0m"
#sleep 1
#wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/trojan-go.sh && chmod +x trojan-go.sh && screen -S trojan-go ./trojan-go.sh
#echo -e "\e[0;32mDONE INSTALLING TROJAN GO\e[0m"
#clear
#install SET-BR
echo -e "========================="
echo -e "Installing Set-BR"
echo -e "========================="
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
#install ohp-server
echo -e "========================="
echo -e "Installing ohp port"
echo -e "========================="
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/ohp-dropbear.sh && chmod +x ohp-dropbear.sh && ./ohp-dropbear.sh
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/install/ohp-ssh.sh && chmod +x ohp-ssh.sh && ./ohp-ssh.sh
clear
#install websocket
echo -e "========================="
echo -e "Installing Websocket Port"
echo -e "========================="
wget https://raw.githubusercontent.com/${GitUser}/V2Remake/main/websocket-python/websocket.sh && chmod +x websocket.sh && screen -S websocket.sh ./websocket.sh
clear
# set time GMT +8
...
# block torrent v2
echo -e "========================="
echo -e "Installing anti-torrent & p2p traffic"
echo -e "========================="
wget https://github.com/JebonRX/block-torrent-on-server/raw/main/btorrent.sh && chmod +x btorrent.sh && screen -S btorrent.sh ./btorrent.sh
# finish
...
echo ""  | tee -a log-install.txt
echo "    [SSH & OpenVPN]" | tee -a log-install.txt
echo "    ---------------" | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "    [Squid, Badvpn, Nginx]" | tee -a log-install.txt
echo "    ----------------------" | tee -a log-install.txt
...
#echo ""  | tee -a log-install.txt
echo "    [XRAYS]" | tee -a log-install.txt
echo "    ----------------" | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
#echo "    [TROJAN]" | tee -a log-install.txt
#echo "    ------------------" | tee -a log-install.txt
#echo "   - Trojan Go               : 2096"  | tee -a log-install.txt
#echo ""  | tee -a log-install.txt
echo "    [CLASH FOR ANDROID (YAML)]" | tee -a log-install.txt
echo "    ------------------------------------" | tee -a log-install.txt
...
echo "------------------------Script By V2Remake---------------------" | tee -a log-install.txt
clear
echo ""
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
