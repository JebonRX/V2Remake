...
# Installation Xray Core (XTLS Direct / Splice)
...
wget -O port-trojan "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/change-port/port-trojan.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/menu/xraay.sh"
wget -O trafficxray "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/trafficxray.sh"
chmod +x port-xray
chmod +x port-trojan
chmod +x certv2ray
chmod +x trojaan
