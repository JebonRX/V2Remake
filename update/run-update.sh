...
wget -O bannermenu "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/update/bannermenu.sh"
wget -O change-port "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/change.sh"
wget -O add-ws "https://raw.githubusercontent.com/${GitUser}/V2Remake/main/add-user/add-ws.sh"
chmod +x update
chmod +x bannermenu
chmod +x change-port
chmod +x add-ws
